    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_band', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='MMB.BandModel')),
                ('id_member', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='MMB.MemberModel')),
            ],
            options={
                'db_table': 'membership',
            },
